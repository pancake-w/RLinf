...
def convert_libero_obs_to_gr00t_1_7_format(env_obs):
    """
    Convert the observation to the format expected by the gr00t_1_7 model.
...
def convert_maniskill_obs_to_gr00t_1_7_format(env_obs):
    """
    Convert the observation to the format expected by the gr00t_1_7 model.
    The data format is determined by the modality_config and meta/info.json following LeRobot format.
    Considering that we don't have a unified data inferface, we use direct logic here.
...
def convert_to_maniskill_action(
    ...
    """Convert gr00t_1_7 action chunk to Maniskill format."""
...
def convert_to_isaaclab_stack_cube_action(
    ...
    """Convert gr00t_1_7 action chunk to Isaaclab Stack Cube format.
    ...
    Args:
        action_chunk: Dictionary of action components from gr00t_1_7 policy
...
OBS_CONVERSION = {
    "maniskill": convert_maniskill_obs_to_gr00t_1_7_format,
    "libero": convert_libero_obs_to_gr00t_1_7_format,
    "isaaclab_stack_cube": convert_libero_obs_to_gr00t_1_7_format,
}
